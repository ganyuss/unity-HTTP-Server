...
namespace UnityHttpServer.ResponseContent
{
    ...
    public class FileHttpResponseContent : IHttpResponseContent
    {
        ...
        public long ContentSize => FileInfo.Length;
        ...
        public FileHttpResponseContent([NotNull] FileInfo fileInfo)
        {
            FileInfo = fileInfo;
            ContentType = GetContentTypeFor(fileInfo);
            ContentEncoding = GetEncoding(fileInfo);
        }
        ...
        private string GetContentTypeFor(FileInfo fileInfo)
        {
            if (MimeTypeMappings.TryGetValue(fileInfo.Extension, out var mimeType))
                return mimeType;
